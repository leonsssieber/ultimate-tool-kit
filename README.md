...
## ✨ Tools included (125+ across 15 categories)

| Category | Tools |
|---|---|
| **Image** | Converter (PNG/JPG/WebP/AVIF/BMP), Compressor, Resizer (+social presets), JPG↔PNG / WebP one-click converters, HEIC→JPG, AI/EPS/PDF→PNG, SVG→PNG, Image→ICO favicon, **Grid / Page Split (equal grid or A4-style aspect tiling)**, Circle Crop, Flip & Rotate, Watermark, Remove EXIF, Invert, Grayscale, Sepia, Adjustments, Add Border, Rounded Corners |
...
| **Time** | Stopwatch, Countdown, Pomodoro, World Clock, Timestamp Converter, Event Countdown, Time Zone Converter |
| **Creative** | Color Picker, Gradient Generator, Whiteboard, Signature Maker, Pixel Art, CSV Chart Maker, Color Palette Extractor, Contrast Checker, Box Shadow Generator |
...
| **Fun** | Random Spinner, Coin Flip, Dice Roller, Random Number Generator, List Randomizer |
